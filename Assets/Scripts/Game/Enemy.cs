...
public class Enemy : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
         ...
         */
        GameObject player = GameManager.Instance.NearestPlayer(mRigidBody.transform.position);
        ...
        if (player != null)
        {
            ...
            mRigidBody.MovePosition(transform.position + transform.forward * Time.deltaTime * speed);
        }
    }
